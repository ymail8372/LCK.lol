...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/ranking/ranking_16spring_style.css">
</head>
<body>
	...
	<div id="wrap">
		...
		<section id="winner">
			...
			<table class="table1">
				...
				<tr>
					<td colspan="3" class="img"><div class="img_container"><img src="${pageContext.request.contextPath}/resources/img/team/2016spring/SKT.png"></div>
		...
		<section id="regular_season">
			...
			<table>
				...
				<tr>
					...
					<td><img style="height: 25px;" src="${pageContext.request.contextPath}/resources/img/team/2016spring/ROX.png"></td>
					<td>ROX</td>
					<td>16</td>
					<td>2</td>
					<td>34승 7패</td>
					...
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2016spring/SSG.png"></td>
					<td>SSG</td>
					<td>10</td>
					<td>8</td>
					<td>22승 22패</td>
				...
				<tr>
					...
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2016spring/KT.png"></td>
					<td>KT</td>
					<td>13</td>
					<td>5</td>
					<td>29승 14패</td>
					...
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2016spring/LZ.png"></td>
					<td>LZ</td>
					<td>8</td>
					<td>10</td>
					<td>21승 22패</td>
				...
				<tr>
					...
					<td><img style="height: 40px;" src="${pageContext.request.contextPath}/resources/img/team/2016spring/SKT.png"></td>
					<td>SKT</td>
					<td>12</td>
					<td>6</td>
					<td>26승 15패</td>
					...
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2016spring/CJ.png"></td>
					<td>CJ</td>
					<td>8</td>
					<td>10</td>
					<td>19승 27패</td>
				...
				<tr>
					...
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2016spring/JAG.png"></td>
					<td>JAG</td>
					<td>10</td>
					<td>8</td>
					<td>24승 22패</td>
					...
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2016spring/SBENU.png"></td>
					<td>SSB</td>
					<td>2</td>
					<td>16</td>
					<td>9승 32패</td>
				...
				<tr>
					...
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2016spring/AF.png"></td>
					<td>AF</td>
					<td>10</td>
					<td>8</td>
					<td>23승 19패</td>
					...
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2016spring/KDM.png"></td>
					<td>KDM</td>
					<td>1</td>
					<td>17</td>
					<td>8승 35패</td>
