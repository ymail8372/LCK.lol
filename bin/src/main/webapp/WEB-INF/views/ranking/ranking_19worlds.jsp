...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/ranking/ranking_19worlds_style.css">
	...
	<div id="wrap">
		...
		<section id="winner">
			...
			<table class="table1 box">
				...
				<tr>
					<td colspan="3" class="img"><img src="${pageContext.request.contextPath}/resources/img/team/2019worlds/FPX.png"><div class="team_name">FunPlus Phoenix</div><span class="star">★</span></td>
				</tr>
				<tr>
					<th>감독</th>
					<td>&nbsp;&nbsp;&nbsp;WarHorse 천쥬친 <img class="country" src="${pageContext.request.contextPath}/resources/img/country/Taiwan.svg"></td>
					<td class="blank"></td>
				</tr>
				<tr>
					<th>코치</th>
					<td>&nbsp;&nbsp;&nbsp;REFRA1N 천콴팅 <img class="country" src="${pageContext.request.contextPath}/resources/img/country/Taiwan.svg"></td>
					<td class="blank"></td>
				</tr>
			</table>
			...
			<table class="table2 box">
				...
				<tr>
					<td>Khan 김동하<img class="country" src="${pageContext.request.contextPath}/resources/img/country/Korea.svg"></td>
					<td></td>
					<td></td>
					<td></td>
					<td></td>
		...
		<section id="tournament">
			...
			<table id="quarterfinal">
				...
				<tr class="win">
					<td class="left"><div class="tm_result"></div><img src="${pageContext.request.contextPath}/resources/img/team/2019worlds/G2.png"></td>
				...
				<tr class="win">
					<td class="left"><div class="tm_result"></div><img src="${pageContext.request.contextPath}/resources/img/team/2019worlds/SKT.png"></td>
				...
				<tr class="lose">
					...
					<td class="middle"><span class="tm_team">Splyce</span></td>
					<td class="right"><span class="tm_score">1</span></td>
				</tr>
				<tr class="blanc" style="height: 30px;">
					<td></td>
				...
				<tr class="lose">
					<td class="left"><div class="tm_result"></div><img src="${pageContext.request.contextPath}/resources/img/team/2019worlds/GRF.png"></td>
					<td class="middle"><span class="tm_team">Griffin</span></td>
					<td class="right"><span class="tm_score">1</span></td>
				</tr>
				<tr class="win">
					<td class="left"><div class="tm_result"></div><img src="${pageContext.request.contextPath}/resources/img/team/2019worlds/IG.png"></td>
				...
				<tr class="win">
					<td class="left"><div class="tm_result"></div><img src="${pageContext.request.contextPath}/resources/img/team/2019worlds/FPX.png"></td>
					<td class="middle"><span class="tm_team">FunPlus Phoenix</span></td>
					<td class="right"><span class="tm_score">3</span></td>
				</tr>
				<tr class="lose">
					<td class="left"><div class="tm_result"></div><img src="${pageContext.request.contextPath}/resources/img/team/2019worlds/FNC.png"></td>
		...
		<section id="groups">
			...
			<table class="box">
				...
				<tr>
					...
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2019worlds/GRF.png"></td>
					<td>⁠Griffin</td>
					<td>6</td>
					<td>1</td>
				</tr>
				<tr>
					...
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2019worlds/G2.png"></td>
					<td>⁠⁠G2 Esports</td>
					<td>5</td>
					<td>2</td>
				</tr>
				<tr>
					...
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2019worlds/C9.png"></td>
					<td>Cloud9</td>
					<td>2</td>
					<td>4</td>
				</tr>
				<tr>
					...
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2019worlds/HKA.png"></td>
			...
			<table class="box">
				...
				<tr>
					<td style="background-color: #AADDFF;">1</td>
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2019worlds/FPX.png"></td>
				...
				<tr>
					<td style="background-color: #97ECAB;">2</td>
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2019worlds/SPY.png"></td>
					<td>⁠⁠Splyce</td>
					<td>4</td>
					<td>3</td>
				</tr>
				<tr>
					<td style="background-color: #FFFF99">3</td>
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2019worlds/JT.png"></td>
					<td>⁠J Team</td>
					<td>3</td>
					<td>3</td>
				</tr>
				<tr>
					<td style="background-color: #FFFF99">4</td>
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2019worlds/GAM.png"></td>
					<td>⁠GAM Esports</td>
					<td>1</td>
					<td>5</td>
				</tr>
			...
			<table class="box">
				...
				<tr>
					<td style="background-color: #AADDFF;">1</td>
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2019worlds/SKT.png"></td>
					<td>SK Telecom T1</td>
					<td>5</td>
					<td>1</td>
				</tr>
				<tr>
					<td style="background-color: #97ECAB;">2</td>
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2019worlds/FNC.png"></td>
					<td>⁠⁠Fnatic</td>
					<td>4</td>
					<td>2</td>
				</tr>
				<tr>
					<td style="background-color: #FFFF99">3</td>
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2019worlds/RNG.png"></td>
				...
				<tr>
					<td style="background-color: #FFFF99">4</td>
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2019worlds/CG.png"></td>
					<td>⁠Clutch Gaming</td>
					<td>0</td>
					<td>6</td>
				</tr>
			...
			<table class="box">
				...
				<tr>
					<td style="background-color: #AADDFF;">1</td>
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2019worlds/DWG.png"></td>
					<td>⁠DAMWON Gaming</td>
					<td>5</td>
					<td>1</td>
				</tr>
				<tr>
					<td style="background-color: #97ECAB;">2</td>
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2019worlds/IG.png"></td>
				...
				<tr>
					<td style="background-color: #FFFF99">3</td>
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2019worlds/TL.png"></td>
					<td>Team Liquid</td>
					<td>3</td>
					<td>3</td>
				</tr>
				<tr>
					<td style="background-color: #FFFF99">4</td>
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2019worlds/AHQ.png"></td>
		...
		<section id="playins1R">
			...
			<table class="box">
				...
				<tr>
					<td style="background-color: #97ECAB;">2</td>
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2019worlds/UOL.png"></td>
				...
				<tr>
					<td style="background-color: #FFFF99">3</td>
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2019worlds/MMM.png"></td>
					<td>MAMMOTH</td>
					<td>2</td>
					<td>3</td>
				</tr>
			...
			<table class="box">
				...
				<tr>
					<td style="background-color: #97ECAB;">2</td>
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2019worlds/ISG.png"></td>
					<td>⁠Isurus</td>
					<td>2</td>
					<td>2</td>
				</tr>
				<tr>
					<td style="background-color: #FFFF99">3</td>
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2019worlds/DFM.png"></td>
			...
			<table class="box">
				...
				<tr>
					<td style="background-color: #97ECAB;">2</td>
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2019worlds/LK.png"></td>
				...
				<tr>
					<td style="background-color: #FFFF99">3</td>
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2019worlds/MEGA.png"></td>
					<td>MEGA</td>
					<td>1</td>
					<td>3</td>
				</tr>
			...
			<table class="box">
				...
				<tr>
					<td style="background-color: #97ECAB;">2</td>
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2019worlds/RY.png"></td>
					<td>⁠Royal Youth</td>
					<td>2</td>
					<td>3</td>
				</tr>
				<tr>
					<td style="background-color: #FFFF99">3</td>
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2019worlds/FLA.png"></td>
		...
		<section id="playins2R">
			<table class="box">
				...
				<tr class="lose">
					<td class="left"><div class="tm_result"></div><img src="${pageContext.request.contextPath}/resources/img/team/2019worlds/LK.png"></td>
					<td class="middle"><span class="tm_team">⁠Lowkey Esports</span></td>
					<td class="right"><span class="tm_score">3</span></td>
				</tr>
			</table>
			...
			<table class="box">
				...
				<tr class="win">
					...
					<td class="middle"><span class="tm_team">Clutch Gaming</span></td>
					<td class="right"><span class="tm_score">3</span></td>
				</tr>
				<tr class="lose">
					<td class="left"><div class="tm_result"></div><img src="${pageContext.request.contextPath}/resources/img/team/2019worlds/RY.png"></td>
					<td class="middle"><span class="tm_team">Royal Youth</span></td>
					<td class="right"><span class="tm_score">0</span></td>
				</tr>
			</table>
			...
			<table class="box" style="margin-top: 30px;">
				...
				<tr class="lose">
					<td class="left"><div class="tm_result"></div><img src="${pageContext.request.contextPath}/resources/img/team/2019worlds/ISG.png"></td>
					<td class="middle"><span class="tm_team">Isurus Gaming</span></td>
					<td class="right"><span class="tm_score">1</span></td>
				</tr>
			</table>
			...
			<table class="box" style="margin-top: 30px; margin-bottom: 10px;">
				...
				<tr class="lose">
					<td class="left"><div class="tm_result"></div><img src="${pageContext.request.contextPath}/resources/img/team/2019worlds/UOL.png"></td>
					<td class="middle"><span class="tm_team">⁠Unicorns Of Love</span></td>
