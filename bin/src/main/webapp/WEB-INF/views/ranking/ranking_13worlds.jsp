...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/ranking/ranking_13worlds_style.css">
	...
	<div id="wrap">
		...
		<section id="winner">
			...
			<table class="table1 box">
				...
				<tr>
					<td colspan="3" class="img"><img src="${pageContext.request.contextPath}/resources/img/team/2013worlds/SKT.png"><div class="team_name">SK telecom T1</div><span class="star">★</span></td>
				</tr>
				<tr>
					<th>감독</th>
			...
			<table class="table2 box">
				...
				<tr>
					<td><a href="#">Impact 정언영 <img class="country" src="${pageContext.request.contextPath}/resources/img/country/korea.svg"></a></td>
					...
					<td><a href="#">Piglet 채광진 <img class="country" src="${pageContext.request.contextPath}/resources/img/country/korea.svg"></a></td>
					<td><a href="#">PoohManDu 이정현 <img class="country" src="${pageContext.request.contextPath}/resources/img/country/korea.svg"></a></td>
				</tr>
			</table>
		</section>
		...
		<section id="tournament">
			...
			<table id="quarterfinal">
				<th colspan="3">8강</th>
				<tr class="lose">
					<td class="left"><div class="tm_result"></div><img src="${pageContext.request.contextPath}/resources/img/team/2013worlds/GAB.png"></td>
					<td class="middle"><span class="tm_team">Gamania Bears</span></td>
					<td class="right"><span class="tm_score">0</span></td>
				</tr>
				<tr class="win">
					<td class="left"><div class="tm_result"></div><img src="${pageContext.request.contextPath}/resources/img/team/2013worlds/SKT.png"></td>
				...
				<tr class="win">
					<td class="left"><div class="tm_result"></div><img src="${pageContext.request.contextPath}/resources/img/team/2013worlds/NBS.png"></td>
					<td class="middle"><span class="tm_team">NaJin Black Sword</span></td>
					<td class="right"><span class="tm_score">2</span></td>
				</tr>
				<tr class="lose">
					<td class="left"><div class="tm_result"></div><img src="${pageContext.request.contextPath}/resources/img/team/2013worlds/GAB.png"></td>
					<td class="middle"><span class="tm_team">Gambit Gaming</span></td>
				...
				<tr class="win">
					<td class="left"><div class="tm_result"></div><img src="${pageContext.request.contextPath}/resources/img/team/2013worlds/RYL.png"></td>
					<td class="middle"><span class="tm_team">Royal Club</span></td>
					<td class="right"><span class="tm_score">2</span></td>
				</tr>
				<tr class="lose">
					<td class="left"><div class="tm_result"></div><img src="${pageContext.request.contextPath}/resources/img/team/2013worlds/OMG.png"></td>
				...
				<tr class="lose">
					<td class="left"><div class="tm_result"></div><img src="${pageContext.request.contextPath}/resources/img/team/2013worlds/C9.png"></td>
					<td class="middle"><span class="tm_team">Cloud9</span></td>
					<td class="right"><span class="tm_score">1</span></td>
				</tr>
				<tr class="win">
					<td class="left"><div class="tm_result"></div><img src="${pageContext.request.contextPath}/resources/img/team/2013worlds/FNC.png"></td>
		...
		<section id="groups">
			...
			<table class="box">
				...
				<tr>
					...
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2013worlds/OMG.png"></td>
					<td>⁠OMG</td>
					<td>7</td>
					<td>1</td>
				</tr>
				<tr>
					...
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2013worlds/SKT.png"></td>
					<td>SK Telecom T1</td>
					<td>7</td>
					<td>1</td>
				</tr>
				<tr>
					...
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2013worlds/LMD.png"></td>
					<td>⁠Lemondogs</td>
					<td>3</td>
					<td>5</td>
				</tr>
				<tr>
					...
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2013worlds/TSM.png"></td>
					<td>TSM</td>
					<td>2</td>
					<td>6</td>
				</tr>
				<tr>
					...
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2013worlds/GG.png"></td>
					<td>GamingGear.eu</td>
					<td>1</td>
					<td>7</td>
				</tr>
			...
			<table class="box">
				...
				<tr>
					<td style="background-color: #AADDFF;">1</td>
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2013worlds/FNC.png"></td>
					<td>Fnatic</td>
					<td>7</td>
					<td>1</td>
				</tr>
				<tr>
					<td style="background-color: #AADDFF;">2</td>
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2013worlds/GAB.png"></td>
					<td>⁠Gambit Gaming</td>
					<td>6</td>
					<td>3</td>
				</tr>
				<tr>
					<td style="background-color: #FFFF99">3</td>
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2013worlds/SSO.png"></td>
					<td>Samsung Galaxy Ozone</td>
					<td>5</td>
					<td>4</td>
				</tr>
				<tr>
					<td style="background-color: #FFFF99">4</td>
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2013worlds/VUL.png"></td>
					<td>⁠Vulcun TechBargains</td>
					<td>3</td>
					<td>5</td>
				</tr>
				<tr>
					<td style="background-color: #FFFF99">5</td>
					<td><img src="${pageContext.request.contextPath}/resources/img/team/2013worlds/MNK.png"></td>
					<td>⁠Team Mineski</td>
					<td>0</td>
					<td>8</td>
				</tr>
